...
if(selected == 'Home Page'):    
    ...
    st.markdown('&emsp;&emsp;&emsp;&emsp;&emsp;This web app predicts various diseases using machine learning models. Please select the disease you would like to predict from the sidebar.')
...
def set_bg_from_url(): 
    ...
    <footer>
        <div style='visibility: visible; padding: 10px; height: auto; display: flex; justify-content: center; align-items: center;'>
